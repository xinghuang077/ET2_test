...
@author: Xing Huang
@date: Jan. 29, 2022
This script is used for testing ET2_test chip TDC module. The mianly function of this script is I2C write and read, Ethernet communication, instrument control and so on.
Revised based on Wei's ETROC1 TDC script.
'''
